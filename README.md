...
| Tracker1 数据与日志 | Docker 命名卷 | `tracker1_data:/fastdfs_data_and_log` |
| Tracker2 数据与日志 | Docker 命名卷 | `tracker2_data:/fastdfs_data_and_log` |
| Storage1 文件与日志 | Docker 命名卷 | `storage1_data:/fastdfs_data_and_log` |
| Storage2 文件与日志 | Docker 命名卷 | `storage2_data:/fastdfs_data_and_log` |
| Storage3 文件与日志 | Docker 命名卷 | `storage3_data:/fastdfs_data_and_log` |
| Storage4 文件与日志 | Docker 命名卷 | `storage4_data:/fastdfs_data_and_log` |
