...
#define FDFS_STORE_LOOKUP_DYNAMIC_LOAD	3  //dynamic group load feedback
...
typedef struct
{
	...
	*/
	...
	time_t last_heart_beat_time;
	    ...
	    int cpu_usage_permille;     //CPU usage rate * 1000
	    int memory_usage_permille;  //memory usage rate * 1000
	} FDFSStorageStat;
...
typedef struct
{
	    ...
	    char sz_cpu_usage_permille[4];
	    char sz_memory_usage_permille[4];
